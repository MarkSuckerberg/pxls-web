...
export const SLIDEIN = (() => {
	...
	function _buildSlideinDom(slidein) {
		...
		const _dom = crel(
			"div",
			{ class: `slidein ${_class}`, "data-icon": slidein.icon, "data-type": slidein.type, "data-closeable": slidein.closeable },
			crel("div", { class: "slidein-icon" }, !slidein.icon ? null : crel("i", { class: `fas fa-${slidein.icon}` })),
			crel("div", { class: "slidein-body" }, slidein.content instanceof HTMLElement ? slidein.content : crel("p", slidein.content), slidein.closeable ? _close : null)
		);
