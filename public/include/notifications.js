...
module.exports.notifications = (function () {
	const self = {
		...
		makeDomForNotification(notification) {
			...
			return crel(
				"article",
				{ class: "notification", "data-notification-id": notification.id },
				...
				crel(
					...
					notification.expiry !== 0 ? crel("span", { class: "notification-expiry float-left" }, crel("i", { class: "far fa-clock fa-is-left" }), crel("span", { title: moment.unix(notification.expiry).format("MMMM DD, YYYY, hh:mm:ss A") }, i18n(__("Expires {expiry}"), { expiry: expiry }))) : null
				)
			);
		},
	};
