...
const modal = (function () {
	return {
		showText: function (text, opts) {
			...
			return modal.show(modal.buildDom(crel("h2", { class: "modal-title" }, opts.title || "Pxls"), crel("p", { style: "margin: 0;" }, text)), opts.modalOpts);
		},
		...
		buildDom: function (headerContent, bodyContent, footerContent) {
			return crel(
				"div",
				{ class: "modal panel", tabindex: "-1", role: "dialog" },
				crel(
					"div",
					{ class: "modal-wrapper", role: "document" },
					headerContent == null ? null : crel("header", { class: "modal-header panel-header" }, crel("div", { class: "left" }), crel("div", { class: "mid" }, headerContent), crel("div", { class: "right" }, this.buildCloser())),
